...
urlpatterns = [
    ...
    url(r'^ab$', csrf_exempt(views_api.ab)),
    ...
    url(r'^devices/(?P<guid>[^/]+)/disable$', csrf_exempt(lambda request, guid: views_api.device_status(request, guid, 'disable'))),
    url(r'^devices/(?P<guid>[^/]+)/enable$', csrf_exempt(lambda request, guid: views_api.device_status(request, guid, 'enable'))),
    ...
    url(r'^users/invite$', csrf_exempt(views_api.users_invite)),
    url(r'^users/tfa/totp/enforce$', csrf_exempt(views_api.users_tfa_enforce)),
    url(r'^users/disable_login_verification$', csrf_exempt(views_api.users_disable_login_verification)),
    url(r'^users/force-logout$', csrf_exempt(views_api.users_force_logout)),
    url(r'^users/(?P<guid>[^/]+)/disable$', csrf_exempt(lambda request, guid: views_api.user_status(request, guid, 'disable'))),
    url(r'^users/(?P<guid>[^/]+)/enable$', csrf_exempt(lambda request, guid: views_api.user_status(request, guid, 'enable'))),
